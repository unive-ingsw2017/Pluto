...
public final class SQLiteConnection implements CancellationSignal.OnCancelListener {
    ...
    private void bindArguments(PreparedStatement statement, Object[] bindArgs) {
        ...
        if (count != statement.mNumParameters) {
            String message = "Expected " + statement.mNumParameters + " bind arguments but " + count + " were provided.";
        ...
        for (int i = 0; i < count; i++) {
            ...
            switch (getTypeOfObject(arg)) {
                ...
                case Cursor.FIELD_TYPE_INTEGER:
                    long l;
                    if (arg instanceof SQLiteBindableLong) {
                        l = ((SQLiteBindableLong) arg).getLong();
                    } else {
                        l = ((Number) arg).longValue();
                    }
                    nativeBindLong(mConnectionPtr, statementPtr, i + 1, l);
                    break;
    ...
    private static int getTypeOfObject(Object obj) {
        if (obj == null) {
            ...
            return Cursor.FIELD_TYPE_FLOAT;
                ...
                || obj instanceof Short || obj instanceof Byte || obj instanceof SQLiteBindableLong) {
